...
namespace Data.ModelTypeFluentAPIConfigurations
{
    class BuffEntityTypeConfiguration : IEntityTypeConfiguration<Buff>
    {
        ...
        public void ConfigureYoutubeLevel(EntityTypeBuilder<Buff> builder)
        {
            ...
            CreateBuff(builder, new Point(768, 448 - 112 + 80), new Size(64, 64), "Protein.png", new TimeSpan(7000), BuffType.Damage, 1);
            CreateBuff(builder, new Point(3232, 448 - 32 + 80), new Size(64, 64), "Protein.png", new TimeSpan(7000), BuffType.Damage, 1);
        }
